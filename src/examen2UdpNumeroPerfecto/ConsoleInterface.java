...
public class ConsoleInterface {
    ...
    /**
     * Constructor que permite introducir una secuencia de caracteres simulando la 
     * pulsación de teclas. La secuencia de texto puede ser tan larga como sea 
     * necesario e incorporar tantas lecturas separadas per retornos de línea 
     * como quiera.
     * @param scannerText cadena de caracteres con pulsación de teclas predefinida.
     */
     ...
     * introducción.
     * @param message Mensaje a mostrar por pantalla antes de demandar el 
     * valor numerico.
     ...
     * esperara la introducción de un caracter desde teclado. Si el usuario introduce 
     * un caracter igual al segundo parametro, retornara cierto. En caso contrario
     * devolvera falso.
     * El tercer parametro permite indicar si se desea hacer un cambio a 
     * mayusculas o minúsculas de la tecla pulsada por el usuario. El valor 
     * TO_UPPER_CASE (2) cambiara siempre el valor introducido a mayúsculas antes 
     * de hacer la comparación. El valor TO_LOWER_CASE (1) pasara el valor a 
     * minúsculas y cualquier otro valor no realizara ningun cambio.
     * @param message Mensaje a mostrar por pantalla antes de pedir el 
     * valor a introducir desde teclado.
     * @param yesChar. Es un caracter equivalente al valor afirmativo o cierto para 
     * poder comparar con el valor introducido por el usuario.
     * @param changeCase. es un valor numerico que indica si quiere cambiar el valor 
     * del usuario a mayúsculas o minúsculas.
     * @return el valor numerico introducido desde teclado.
     */
    public boolean readYesNo(String missatge, char yesChar, int changeCase){
       ...
       do{
            ...
            if(!correct){
                System.out.println("Puede escribir un caracter y pulsar "
                        + "'Entrar'");
            }
       }while(!correct);
     ...
     * parametro.
     * @param ex. Es la excepción para la que se ha de mostrar el mensaje de error. 
     */
     ...
     * @param ex. excepción lanzada para la que se ha producido el error.
     */
    ...
    /**
     * Devuelve cierto si hay un caracter disponible en el buffer del teclado. Este 
     * metodo no es bloqueante, por lo que puede ser muy útil para sistemas que no 
     * se puedan bloquear esperando la respuesta del usuario.
     * @return 
     */
